...
const EventModalComponent = () => {
    ...
    let initialTime = now.toISOString().split('T')[1].split(':')[0] + ':' + now.toISOString().split('T')[1].split(':')[1];
    ...
    const [startEventTime, setStartEventTime] = useState(initialTime)
    const [endEventTime, setEndEventTime] = useState(initialTime)
