...
func TestGetEvents(t *testing.T) {
	...
	eventsRow := sqlmock.NewRows([]string{
		...
		sqlTimeEnd, "owner_id", "channel-id", false, "", nil, "team1", "private", "", nil, "call", nil).AddRow("event-2", "test event 2", "", sqlTimeStart, sqlTimeEnd, sqlTimeEnd,
		sqlTimeEnd, "owner_id", "channel-id", false, "", "#D0D0D0", "team1", "private", "", nil, "call", nil).AddRow("event-3", "test event 3", "", sqlTimeStart, sqlTimeEnd, sqlTimeEnd,
		sqlTimeEnd, "owner_id", "channel-id", true, "RRULE:FREQ=WEEKLY;INTERVAL=1;BYDAY=MO,TU,WE", "#D0D0D0", "team1", "private", "", nil, "call", nil).AddRow("event-3", "test event 3 another user", "", sqlTimeStart, sqlTimeEnd, sqlTimeEnd,
		sqlTimeEnd, "owner_id", "channel-id", true, "RRULE:FREQ=WEEKLY;INTERVAL=1;BYDAY=MO,TU,WE", "#D0D0D0", "team1", "private", "", nil, "call", nil).AddRow("event-3", "test event 3 another user", "", sqlTimeStart, sqlTimeEnd, sqlTimeEnd,
		sqlTimeEnd, "owner_id", "channel-id", true, "RRULE:FREQ=WEEKLY;INTERVAL=1;BYDAY=MO,TU,WE", "#D0D0D0", "team1", "private", "", nil, "call", nil)
